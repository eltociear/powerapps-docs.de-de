...
Durch Ausführen der in diesem Artikel beschriebenen Schritte erstellen Sie eine App, in der Benutzer Kontakte in Dynamics 365 durchsuchen, hinzufügen, löschen und aktualisieren können. Benutzer können die App [in einem Browser](../run-app-browser.md) oder [auf einem mobilen Gerät](../run-app-client.md) wie einem Smartphone ausführen.
