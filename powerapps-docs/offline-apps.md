...
1. Beim Starten der App (basierend auf der Eigenschaft **OnVisible** des ersten Bildschirms):
   ...
   * Wenn das Gerät offline ist, laden wir die Daten mithilfe von [LoadData](functions/function-savedata-loaddata.md) aus einer lokalen Cachedatei.
...
2. Im Onlinemodus geschieht alle 5 Minuten Folgendes:
   ...
   * Wir aktualisieren den lokalen Cache und speichern ihn mithilfe von [SaveData](functions/function-savedata-loaddata.md).
