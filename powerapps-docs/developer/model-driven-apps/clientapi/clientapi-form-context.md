...
Früher wurde das globale **Xrm.Page**-Objekt dazu verwendet, um ein Formular oder ein Element im Formular darzustellen. Mit Version 9.0 ist das **Xrm.Page**-Object [veraltet](/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming#some-client-apis-are-deprecated), und Sie sollen nun die [getFormContext](reference/executioncontext/getFormContext.md)-Methode aus dem zur Ausführung übergabenen Kontextobjekt verwenden, um die Referenz ins entsprechende Formular oder ein Element im Formular zurückzugeben.
