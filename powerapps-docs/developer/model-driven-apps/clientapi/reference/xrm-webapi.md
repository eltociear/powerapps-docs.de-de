---
title: Xrm.WebApi (Client-API-Referenz) in modellgestützten Apps | MicrosoftDocs
ms.date: 10/31/2018
...
search.app:
  ...
  - D365CE
---
# <a name="xrmwebapi-client-api-reference"></a>Xrm.WebApi (Client-API-Referenz)



Stellt Eigenschaften und Methoden zur Verwendung der Web-API bereit, um Datensätze zu erstellen und zu verwalten sowie Web-API-Aktionen und -Funktionen in modellgesteuerten Apps auszuführen. 
...
[Verwenden der Common Data Service für Apps-Web-API](../../../common-data-service/webapi/overview.md)
