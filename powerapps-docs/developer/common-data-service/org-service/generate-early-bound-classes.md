...
Diese Assemblys, die Sie benötigen, sind im [Microsoft.CrmSdk.CoreAssemblies](https://www.nuget.org/packages/Microsoft.CrmSdk.CoreAssemblies/) NuGet-Paket enthalten. Verwenden Sie diese NuGet-Pakete, um diese Assemblys Ihrem Visual Studio-Projekt hinzuzufügen.
