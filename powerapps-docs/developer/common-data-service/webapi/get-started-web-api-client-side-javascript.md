---
title: Erste Schritte mit Common Data Service for Apps Web-API (clientseitiges JavaScript) | Microsoft Docs
description: 'JavaScript kann in HTML-Webressourcen, Formularskripten oder Menübandbefehlen verwendet werden, um Vorgänge in Common Data Service für Appsdata  mit Internet API auszuführen'
ms.custom: ''
ms.date: 10/31/2018
ms.reviewer: ''
...
search.app:
  ...
  - D365CE
---
# <a name="get-started-with-the-common-data-service-for-apps-web-api-client-side-javascript"></a>Erste Schritte mit Common Data Service for Apps Web-API (clientseitiges JavaScript)

<!-- TODO: 
> [!NOTE]
> ![This page is under construction. Check back soon!](../../media/under_construction.png "Coming soon") [!INCLUDE[cc-under-construction](../../includes/cc-under-construction.md)] -->

JavaScript kann in HTML-Webressourcen, Formularskripten oder Menübandbefehlen verwendet werden, um Vorgänge in Common Data Service für Appsdata  mit Internet API auszuführen, die mit CDS für Apps eingeführt wurde.
...
Falls Sie eine frühere Version des Common Data Service für Apps Customer Engagement verwenden, folgen Sie den Installationsanweisungen, die unter folgendem Link verfügbar sind [Erste Schritte mit dem Microsoft Common Data Service für Apps Web API (clientseitiges JavaScript)](https://msdn.microsoft.com/library/gg334279.aspx)  
...
[Verwenden von OAuth mit Cross-Origin Resource Sharing, um eine Single Page-Anwendung mit  zu verbinden](../oauth-cross-origin-resource-sharing-connect-single-page-application.md)
