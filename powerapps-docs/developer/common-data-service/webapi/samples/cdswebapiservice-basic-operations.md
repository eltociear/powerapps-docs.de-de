---
title: Web API CDSWebApiService Beispiel für Basisoperationen (C#) (Common Data Service) | Microsoft Docs
description: Dieses Beispiel zeigt, wie grundlegende CRUD- (Create, Retrieve, Update und Delete) sowie Zuordnungs- und Dissoziationsoperationen an Common Data Service-Entitätsinstanzen unter Verwendung der Common Data Service-Web API mit der CDSWebAPIService-Klasse durchgeführt werden
ms.custom: ''
ms.date: 04/20/2020
...
ms.locfileid: "3276706"
---
# <a name="web-api-cdswebapiservice-basic-operations-sample-c"></a>Web API CDSWebApiService Beispiel für Basisoperationen (C#)
...
1. Wählen Sie das Projekt **BasicOperations** und öffnen Sie die Datei App.config. Hierbei handelt es sich um eine gemeinsame [App.config](https://github.com/microsoft/PowerApps-Samples/blob/master/cds/webapi/C%23/CDSWebApiService/App.config) Datei, die von allen Beispielen in dieser Lösung verwendet wird. Sobald Sie diese bearbeiten, können Sie jedes der Beispiele in dieser Lösung ausführen.
...
1. Stellen Sie sicher, dass das Projekt **BasicOperations** als Startprojekt festgelegt ist. Der Name des Projekts sollte fettgedruckt sein, um anzuzeigen, dass es sich um das Startprojekt handelt. Wenn der Name nicht fett ist, klicken Sie im Lösungsexplorer mit der rechten Maustaste darauf und wählen Sie **Als Startprojekt festlegen**.
