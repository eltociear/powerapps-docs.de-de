...
- [Beispiel ausführen](#bkmk_runsample)  
- [Codebeispiel](#bkmk_codeSample)  
...
Die WebAPIFunctionsAndActions.html- Webressource stellt den Kontext bereit, in dem der JavaScript-Code ausgeführt wird.  
...
Die WebAPIFunctionsAndActions.js-Webressource ist die JavaScript-Bibliothek, die die Operationen definiert, die dieses Beispiel ausführt.  
...
[Internet-API-Funktionen- und Aktionen-Beispiel (C#)](functions-actions-csharp.md)<br />
...
[Beispiele bedingter Web API-Operationen (clientseitiges JavaScript)](conditional-operations-client-side-javascript.md)
