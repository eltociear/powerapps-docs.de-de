---
title: Web API-Abfragedatenbeispiele (clientseitiges JavaScript) | Microsoft Docs
ms.custom: ''
ms.date: 10/31/2018
...
ms.locfileid: "3155006"
---
# <a name="web-api-query-data-sample-client-side-javascript"></a>Web API-Abfragedatenbeispiele (clientseitiges JavaScript)

Dieses Beispiel veranschaulicht, wie Sie mithilfe der Common Data Service-Web-API mit clientseitigem JavaScript grundlegende Abfragenanforderungen ausführen.  
...
### <a name="webapiqueryhtml"></a>WebAPIQuery.html  
 ...
 Die WebAPIQuery.html-Webressource stellt den Kontext bereit, in dem der JavaScript-Code ausgeführt wird.  
...
Die WebAPIQuery.js-Webressource ist die JavaScript-Bibliothek, die die Vorgänge definiert, die dieses Beispiel ausgeführt.  
