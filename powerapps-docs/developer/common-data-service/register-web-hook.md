...
Verwenden Sie das Plug-In-Registrierungstool, um einen Webhook zu registrieren. Informationen zum Erhalt des Plug-In-Registrierungstools erhalten Sie unter [Tools von NuGet herunterladen](download-tools-nuget.md). 
