...
| ------------- |----|--------|-----------|
|Name|`string`|Ja|Der Name des Popups, den Sie zu aktualisieren versuchen.|
|newProps|`Popup`|Nein|Die aktualisierten Eigenschaften, die dem Popup übergeben werden sollen.|
