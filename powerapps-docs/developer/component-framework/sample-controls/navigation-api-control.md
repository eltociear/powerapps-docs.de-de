...
Diese Beispielkomponente untersucht die verschiedenen Methoden, die im Rahmen der Navigations-API des PowerApps-Komponenten-Frameworks verfügbar sind. Im vorliegenden Beispiel, erstellen Sie eine Reihe von Eingabeelementen des Typs Schaltfläche , die in die jeweiligen Methoden der Navigations-API anrufen, die dem angezeigten Wert entsprechen.  
