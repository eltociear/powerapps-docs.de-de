...
Diese Beispielkomponente ändert die Benutzerfreundlichkeit beim Interagieren mit numerischen Typen im Formular. Statt die Zahlen über die Tastatur einzugeben, bietet die lineare Eingabekomponente einen lineare Schiebregler, mit dem der Wert des Attributs im Formular festgelegt werden kann.  

Wenn Sie diese Komponente implementieren möchten, müssen Sie die [Manifest](../manifest-schema-reference/manifest.md)-Datei definieren und dann die benutzerdefinierte Logik in TypeScript implementieren.
