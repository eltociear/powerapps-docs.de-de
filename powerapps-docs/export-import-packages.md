...
## <a name="data"></a>Daten
Datenbankdaten als Teil des Exports und Imports von Ressourcen können nicht verschoben werden. Um Daten zu verschieben, können Sie Microsoft Excel verwenden. Weitere Informationen finden Sie unter [Import or export data (Importieren oder Exportieren von Daten)](data-platform-export-data.md).
