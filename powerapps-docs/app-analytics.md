...
Jetzt gibt es den ersten PowerApps-Analysebericht, der als Vorschauversion über [web.powerapps.com](1.md) verfügbar ist: der **App-Nutzungsbericht**.
...
Alle Berichte sind für alle Benutzer mit der Berechtigung „Kann bearbeiten“ für die App verfügbar. Der Benutzer benötigt allerdings einen PowerApps-Plan 2 oder eine PowerApps-Plan 2-Testlizenz, um auf den Bericht zuzugreifen.

*HINWEIS: Während der Vorschauphase der Analyseberichte können alle Benutzer mit einer gültigen PowerApps-Lizenz auf den Bericht zugreifen und ihn testen.*
...
1. Öffnen Sie [web.powerapps.com](1.md).
...
Wenn Sie Feedback, Fragen oder Wünsche haben, freuen wir uns über Ihre Kommentare im [Ideenforum für PowerApps](2.md).
