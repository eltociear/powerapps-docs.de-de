...
| **Funktionen** | **PowerApps für Office 365 Enterprise F1** |
| --- | --- |
| **Erstellen und Ausführen von Apps** | |
| Ausführen von Apps |Ja |
| Apps erstellen |Nein |
| Freigeben von Apps |Nein |
| **Kapazität** | |
| Flowausführungen pro Monat (pro Benutzer) |750 |
| Datenspeicher in Common Data Service (pro Benutzer) |- |
| Dateispeicher in Common Data Service (pro Benutzer) |- |
| **Konnektivität** | |
| Herstellen von Verbindungen mit Office 365, Dynamics 365 und ähnlichen Datenquellen |Ja |
| Herstellen von Verbindungen mit Azure SQL, Dropbox, Twitter und vielen anderen cloudbasierten Diensten |Ja |
| Herstellen von Verbindungen mit Salesforce, DB2 und viele anderen Datenquellen über Premium-Connectors |Nein |
| Zugreifen auf lokale Daten mithilfe eines Gateways |Nein |
| Erstellen benutzerdefinierter Connectors zum Verwalten von Daten in Ihren eigenen Systemen |Nein |
| **Common Data Service** | |
| Erstellen und Ausführen von Apps in Common Data Service |Nein |
| Modellieren Ihrer Daten in Common Data Service |Nein |
| Erstellen einer Datenbank in Common Data Service |Nein |
| **Verwaltung** | |
| Unterstützung der vom Office 365-Administrator eingerichteten Datenrichtlinien |Ja |
...
| Einrichten von Datenrichtlinien für Umgebungen |Nein |
