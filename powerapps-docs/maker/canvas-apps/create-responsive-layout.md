...
| **Lower** | **Breite**    | `Parent.Width`            |
| **Lower** | **Höhe**   | `Parent.Height - Lower.Y` |
...
| **Upper** | **X** | 0 |
| **Upper** | **Y** | 0 |
| **Upper** | **Breite** | `If(Parent.Width < Parent.Height, Parent.Width, Parent.Width / 2)` |
| **Upper** | **Höhe**   | `If(Parent.Width < Parent.Height, Parent.Height / 2, Parent.Height)` |
