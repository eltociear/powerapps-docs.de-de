...
Die **ColorFade**-Funktion gibt eine hellere bzw. dunklere Version einer Farbe zurück. Das Ausblenden variiert von-1, oder -100 % (die lässt eine Farbe auf Schwarz festgelegt, vollständig) auf 0 (keine Auswirkungen auf die Farbe hat), 1 oder 100 % (die vollständig eine Farbe Weiß werden lässt).
...
* *FadeAmount*: Erforderlich.  Eine Zahl zwischen -1 und 1.  -1 lässt eine Farbe vollständig schwarz werden, 0 hat keine Auswirkungen auf die Farbe und 1 lässt eine Farbe vollständig weiß werden. Sie können auch einen Prozentsatz von-100 % und 100 %
