...
Verwenden von integrierten Farbwerten, Definieren von benutzerdefinierten Farben und den alpha-Kanal verwenden.

## <a name="description"></a>Beschreibung

Mithilfe der **Farbe** -Enumeration können Sie problemlos die Farben, die von der HTML-Cascading Stylesheets (CSS) definiert sind zugreifen. Z. B. **Color.Red** gibt reines Rot. Sie finden eine Liste dieser Farben am Ende dieses Themas.

Die **ColorValue** Funktion gibt eine Farbe basierend auf einer in einem CSS-Farbzeichenfolge zurück. Die Zeichenfolge kann eine der folgenden Formen annehmen:

- **Der Name der CSS-Farbe:** **"RoxyBrown"** und **"OliveDrab"** sind Beispiele. Diese Namen sind keine Leerzeichen enthalten. Weiter unten in diesem Thema wird die Liste der unterstützten Farben angezeigt.
- **6-stellige hexadezimaler Wert:** Als Beispiel **"#ffd700"** ist identisch mit **"Gold"** . Die Zeichenfolge weist das Format "#*Rrggbb*", in denen *rr* ist der rote Teil in zwei Hexadezimalzeichen *Gg* ist die grüne, und *bb* ist Blau.
- **8-stellige hexadezimale Wert:** Als Beispiel **"#ff7f5080"** ist identisch mit **"Korallenrot"** mit einem Alphakanal von 50 %. Die Zeichenfolge weist das Format "#*Rrggbbaa*", in denen *rr*, *Gg*, und *bb* sind identisch mit dem Formular 6 Ziffern. Der Alphakanal wird durch dargestellt *aa*: **00** darstellt, die vollständig transparent, und **ff** vollständig deckend darstellt.

Die **RGBA** Funktionsergebnis ist eine Farbe anhand von Rot, Grün und Blau-Komponenten. Die Funktion enthält auch einen alpha-Kanal zum Mischen von Farben von Steuerelementen, die vor den anderen Ebenen auf. Ein alpha-Kanal variiert von 0 oder 0 % (vollständig transparent und unsichtbar) auf 1 oder 100 % (was vollständig deckend ist, und alle Ebenen hinter einem Steuerelement vollständig blockiert).

Die **ColorFade**-Funktion gibt eine hellere bzw. dunklere Version einer Farbe zurück. Das Ausblenden variiert von 1 (d. h., eine Farbe auf Schwarz festgelegt, vollständig zu dunkelt) auf 0 (d. h. die Farbe nicht beeinträchtigt) auf 1 (die vollständig eine Farbe Weiß werden lässt).

## <a name="alpha-channel"></a>Alpha-Kanal

In einer Canvas-app können Sie Steuerelemente vor anderen auf verschiedenen Ebenen und geben die Transparenz eines Steuerelements zu allen Steuerelementen, die zugrunde liegende sind. Farben werden daher durch die Ebenen in blend. Dieses Diagramm veranschaulicht beispielsweise die drei Primärfarben wie mit einer alpha-Einstellung von 50 % zu kombinieren:

> [!div class="mx-imgBorder"]
> ![Drei Primärfarben mit einer alpha-Einstellung von 50 %](media/function-colors/alpha-primary.png)

Sie können auch Bilder in Dateiformaten blend, die alpha-Kanäle unterstützen. Beispielsweise können nicht Sie JPEG-Dateien in blend, aber Sie können PNG-Dateien in blend. Die nächste Abbildung zeigt das gleiche rote, grüne und blaue Farben aus dem vorherigen Beispiel, aber die Farbe Rot wird als eine Wellenlinie (anstelle von einem Kreis) in eine PNG-Datei mit einem Alphakanal von 50 %:

> [!div class="mx-imgBorder"]
> ![Rote Wellenlinie, die mit einer alpha-Einstellung von 50 % vor Grün und Blau Kreise](media/function-colors/alpha-image.png)

Bei Angabe einer **Farbe** Enumerationswert oder Sie erstellen eine **ColorValue** Formel einen Farbnamen oder einen Hexadezimalwert der 6 Ziffern, die alpha-Einstellung ist 100 % vollständig deckend.

## <a name="syntax"></a>Syntax

**Color**.*ColorName*

- *ColorName*: Erforderlich.  Name einer Cascading Stylesheet-Farbe (CSS). Am Ende dieses Themas wird die Liste der möglichen Werte angezeigt.

**ColorValue**( *CSSColor* )

- *CSSColor*: Erforderlich.  Name einer Cascading Stylesheet-Definition (CSS). Sie können entweder einen Namen ein, z. B. angeben **OliveDrab**, oder ein hexadezimaler Wert, z. B. **#6b8e23** oder **#7fffd420**. Hex-Werte können entweder # sind*Rrggbb* oder #*Rrggbbaa*.

**RGBA**( *Red*, *Green*, *Blue*, *Alpha* )

- *Red*, *Green*, *Blue*: Erforderlich.  Farbkomponente Werte, Bereich von 0 (keine Sättigung) bis zu 255 (vollständige Sättigung).
- *Alpha*: Erforderlich.  Alpha-Komponente, die von 0 (vollständig transparent) zu 1 (vollständig deckend bis). Sie können auch einen Prozentsatz, 0 % bis 100 %, verwenden.

**ColorFade**( *Color*, *FadeAmount* )

- *Color*: Erforderlich.  Ein Farbwert wie z.B. **Color.Red** oder die Ausgabe von **ColorValue** oder **RGBA**.
- *FadeAmount*: Erforderlich.  Eine Zahl zwischen -1 und 1. -1 lässt eine Farbe auf Schwarz festgelegt, vollständig, 0 hat keine Auswirkungen, auf die Farbe und 1 werden vollständig lässt eine Farbe Weiß. Sie können auch einen Prozentsatz von-100 % und 100 %.
