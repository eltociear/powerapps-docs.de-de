...
ms.locfileid: "74731308"
ms.PowerAppsDecimalTransform: true
---
# <a name="concat-and-concatenate-functions-in-power-apps"></a>Funktionen "Concat" und "concatenate" in powerapps
...
| Formel | Beschreibung | Ergebnis |
|---------|-------------|--------|
| **Left (Concat (&nbsp;Products,&nbsp;Name&nbsp;&&nbsp;",&nbsp;"&nbsp;), Len (&nbsp;Concat (&nbsp;Products,&nbsp;Name&nbsp;&&nbsp;",&nbsp;"&nbsp;)&nbsp;)&nbsp;-&nbsp;2)** | Gibt das Ergebnis von **Concat** zurück, entfernt jedoch die letzten zwei Zeichen, die das überflüssige Trennzeichen bilden. | "Violine,&nbsp;Cello,&nbsp;Trompete" |
| **Match (Concat (&nbsp;Products,&nbsp;Name&nbsp;&&nbsp;",&nbsp;"&nbsp;) "," ^ (?&lt;Trim&gt;. *),&nbsp;$ "). Trim** | Gibt die Zeichen von **Concat** vom Anfang der Text Zeichenfolge (^) bis zum Ende ($) zurück, enthält jedoch nicht das unerwünschte Komma und den Leerraum am Ende. | "Violine,&nbsp;Cello,&nbsp;Trompete" |
