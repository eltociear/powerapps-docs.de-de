...
ms.locfileid: "77089901"
---
# <a name="update-and-updateif-functions-in-power-apps"></a>Funktionen "Update" und "updateif" in powerapps
...
| **UpdateIf(&nbsp;IceCream, Quantity > 175, {&nbsp;Quantity:&nbsp;Quantity&nbsp;+&nbsp;10&nbsp;} )** |Ändert Datensätze, die eine **Menge** größer als **175**aufweisen.  Das Feld **Quantity** wird um 10 erhöht, und es werden keine anderen Felder geändert. |![](media/function-update-updateif/icecream-mint-plus10.png)<br><br>Die Datenquelle **IceCream** (Eiscreme) wurde geändert. |
