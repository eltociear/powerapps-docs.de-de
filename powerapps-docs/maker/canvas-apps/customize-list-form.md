...
**A:** Ja. Sie können genau wie für eigenständige Apps [Steuerelemente hinzufügen und konfigurieren](add-configure-controls.md), [Verbindungen mit verfügbaren Datenquellen herstellen](add-data-connection.md) oder [eigene Datenquellen hinzufügen](../canvas-apps/register-custom-api.md).
...
**A:** Wenn Sie über einen [Office 365-Plan mit PowerApps](../../administrator/pricing-billing-skus.md#licenses) verfügen, können Sie benutzerdefinierte Listenformulare erstellen und verwenden.
