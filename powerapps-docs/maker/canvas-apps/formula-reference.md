...
**[LoadData](functions/function-savedata-loaddata.md)**: lädt eine Sammlung aus dem privaten Speicher von Power Apps
...
## <a name="s"></a>S
**[SaveData](functions/function-savedata-loaddata.md)**: speichert eine Sammlung im privaten Speicher von Power Apps ab
...
**[Text](functions/function-text.md)**: konvertiert alle Werte und formatiert eine Zahl oder einen Datums-/Uhrzeitwert in eine Textzeichenfolge
