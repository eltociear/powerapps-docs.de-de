...
**[Live](properties-accessibility.md)** – gibt an, wie eine Bildschirmausgabe Änderungen am Wert der **Text** -Eigenschaft der Bezeichnung ankündigt.
...
**Role** : die semantische Rolle des Beschriftungs Texts, z. b. Überschrift 1. Ändert nicht den Stil der Bezeichnung, sondern macht die Ausgabe semantisch korrekt für die Interpretation durch Bildschirm Sprachausgaben.
...
* **[Live](properties-accessibility.md)** sollte auf **höflich** oder **Durchsetzungs** fähig festgelegt werden, wenn eine Sprachausgabe Änderungen am Wert der **Text** -Eigenschaft ankündigen soll.
