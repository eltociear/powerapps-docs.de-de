...
**SelectedItems** - **Schreib**geschützt. Stellt eine Datentabelle für ausgewählte Elemente für ein Mehrfachauswahl-ListBox-Element dar.

**Selecteditemstext** - **Schreib**geschützt. Stellt eine Datentabelle für den Text ausgewählter Elemente für ein Mehrfachauswahl-Listenfeld dar.
