...
Da Sie nun über den ausgewählten Datensatz verfügen, können Sie mit dem **.** -Operator einzelne Felder daraus extrahieren.
...
Wenn die Tabelle, auf der gearbeitet wird, ein Ausdruck ist, z. b. **Filter (** _Tabelle_ **,** ... **)** , kann der mehrdeutigkeits Operator nicht verwendet werden.  Nur die innerste Datensatzebene kann auf Felder aus diesem Tabellenausdruck zugreifen, indem der Operator zur Mehrdeutigkeitsvermeidung nicht verwendet wird.
