...
description: Erstellen Sie in powerapps einen Bildschirm, auf den Benutzer scrollen können, um mehr Inhaltstypen anzuzeigen, als der Bildschirm in einer Canvas-App gleichzeitig anzeigen kann.
author: emcoope-msft
manager: kvivek
