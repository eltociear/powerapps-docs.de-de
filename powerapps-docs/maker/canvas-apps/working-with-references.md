...
1. Scrollen Sie nach unten, bis das Feld **Besitzer** angezeigt wird.
 ...
 > ![Owner Feld für Konto Entität ](media/working-with-references/owner-field.png)
...
> [!div class="mx-imgBorder"]
> ![Accounts in einem Katalog-Steuerelement angezeigt ](media/working-with-references/accounts-gallery.png)
...
> [!div class="mx-imgBorder"]
> ![Accounts-, Teams-und Benutzer Entitäten im Datenbereich ](media/working-with-references/accounts-datasources.png)
...
> [!div class="mx-imgBorder"]
> ![Accounts in einem Katalog-Steuerelement angezeigt, in dem das ](media/working-with-references/accounts-displayowner.png) Feld "Owner"
...
> [!div class="mx-imgBorder"]
> ![Experimental Switch, um die Fehler Verwaltung auf Formel Ebene zu aktivieren ](media/working-with-references/accounts-iferror.png)
...
> [!div class="mx-imgBorder"]
> ![Added Kombinations Feld-Steuerelement oberhalb der Galerie mit der Eigenschaft Items auf Benutzer festgelegt ](media/working-with-references/filter-insert-combobox.png)
...
> [!div class="mx-imgBorder"]
> ![Filtered Galerie basierend auf dem im Kombinations Feld-Steuerelement festgelegten Wert ](media/working-with-references/filter-accounts.png)
...
1. Legen Sie abschließend die **Items** -Eigenschaft des Katalog **-Steuer Elements** auf diese Formel fest:
    ...
    > [!div class="mx-imgBorder"]
    > ![Filtered Katalog, der alle Datensätze oder einen bestimmten Benutzer oder ein bestimmtes Team anzeigt ](media/working-with-references/filter-combobox.png)

Mit diesen Änderungen können Sie alle Datensätze anzeigen oder basierend auf einem Benutzer oder einem Team filtern:

> [!div class="mx-imgBorder"]
> ![Animation die unterschiedliche gefilterte Ergebnisse basierend auf dem Optionsfeld Steuerelement und den Kombinations Feldern anzeigt ](media/working-with-references/filter-allthree.gif)
...
> [!div class="mx-imgBorder"]
> ![Filter nach Besitzertyp mithilfe von istype ](media/working-with-references/filter-bytype.png)
...
1. Wählen Sie im Menü "Ellipsen" die Option **diese Elemente kopieren**aus.
    ...
    > [!div class="mx-imgBorder"]
    > ![Copy mehrerer Steuerelemente mithilfe der Strukturansicht ](media/working-with-references/patch-copy.png)

1. Wählen Sie im gleichen Menü **Einfügen**aus.

    > [!div class="mx-imgBorder"]
    > ![Paste mehrerer Steuerelemente mithilfe der Strukturansicht ](media/working-with-references/patch-paste.png)

1. Verschieben Sie die kopierten Steuerelemente auf die Rechte Seite des Katalogs.

    > [!div class="mx-imgBorder"]
    > ![Moved kopierte Steuerelemente rechts von der Galerie ](media/working-with-references/patch-position.png)
...
1. Wählen Sie das **kopierte** Optionsfeld aus, und ändern Sie dann die folgenden Eigenschaften:
    ...
    > [!div class="mx-imgBorder"]
    > ![Removed die gesamte Auswahl aus dem Optionsfeld ](media/working-with-references/patch-noall.png) 
...
1. Wählen Sie das sichtbare Kombinations **Feld** -Steuerelement aus, und legen Sie dann die **defaultselecteditems** -Eigenschaft auf diese Formel fest:
    ...
    > [!div class="mx-imgBorder"]
    > ![Default festgelegte Eigenschaft für das Kombinations Feld "Benutzer" ](media/working-with-references/patch-default-users.png)
...
1. Wählen Sie das sichtbare Kombinations **Feld** -Steuerelement für Teams aus, und legen Sie dann die Eigenschaft **defaultselecteditems** auf diese Formel fest:
    ...
    > [!div class="mx-imgBorder"]
    > ![Default für das Kombinations Feld "Teams" festgelegte Eigenschaft ](media/working-with-references/patch-default-teams.png)
...
1. Legen **Sie die onselect** -Eigenschaft der Schaltfläche auf die folgende Formel fest:
    ...
    > [!div class="mx-imgBorder"]
    > ![Formula für Schaltflächen-Steuerelement ](media/working-with-references/patch-button.png)
...
1. Öffnen Sie die Liste **Datenquelle** auf der Registerkarte **Eigenschaften** in der Nähe der rechten Seite des Bildschirms, und wählen Sie dann **Konten**aus.
    ...
    > [!div class="mx-imgBorder"]
    > ![Form Steuerelement, das zusätzliche Felder mit leeren Werten anzeigt ](media/working-with-references/form-insert.png)  

1. Legen Sie die **Item** -Eigenschaft des Formulars auf `Gallery1.Selected` fest.

    > [!div class="mx-imgBorder"]
    > ![Form Steuerelement, das zusätzliche Felder anzeigt, die aus dem ausgewählten Element im Katalog aufgefüllt werden ](media/working-with-references/form-item.png)
...
1. Wählen Sie im **Bereich Felder** die Auslassungs Punkte aus, und wählen Sie dann **benutzerdefinierte Karte hinzufügen**aus.
    ...
    > [!div class="mx-imgBorder"]
    > ![Command zum Hinzufügen einer benutzerdefinierten Karte ](media/working-with-references/form-customcard.png)
...
1. Ändern Sie die Größe der Karte nach Bedarf, um den gesamten Text anzuzeigen.
    ...
    > [!div class="mx-imgBorder"]
    > ![Inserted benutzerdefinierte Karte, leer ](media/working-with-references/form-inserted-customcard.png)
...
1. Fügen Sie ein **Label** -Steuerelement in die benutzerdefinierte Karte ein, und legen Sie dann die **Text** -Eigenschaft der Bezeichnung auf die im Katalog verwendete Formel fest:
    ...
    > [!div class="mx-imgBorder"]
    > ![Custom Karte, die das Besitzer Feld in einem Label-Steuerelement anzeigt ](media/working-with-references/form-displayowner.png)
...
> [!div class="mx-imgBorder"]
> ![Accounts-, Teams-, Benutzer-und Kontakt Entitäten im Datenbereich ](media/working-with-references/customer-datasources.png)
...
> [!div class="mx-imgBorder"]
> ![Customer von der Besitzer-App abgeleitete APP, bei der einfache Änderungen vorgenommen wurden ](media/working-with-references/customer-simple-update.png)
...
1. 1: n-Beziehungen zwischen **Konten** und **Kontakten** haben Vorrang, wenn Sie auf diese Entitäts Typen anhand ihres Namens verweisen. Verwenden Sieanstelle von Konten **\[ \@Accounts]** ; Verwenden Sieanstelle von Kontakten **\[ \@Contacts]** . Mit dem [globalen mehrdeutigkeits Operator](functions/operators.md#disambiguation-operator)stellen Sie sicher, dass Sie auf den Entitätstyp in **istype** und **astype**verweisen. Dieses Problem ist nur im Daten Satz Kontext der Katalog-und Formular Steuerelemente vorhanden.
...
> [!div class="mx-imgBorder"]
> ![Update auf die Text-Eigenschaft des Steuer Elements "Untertitel Bezeichnung" in der Galerie ](media/working-with-references/customer-update.png)
...
> [!div class="mx-imgBorder"]
> ![Data Bereich mit Konten, Teams, Benutzern, Kontakten und faxentitäten ](media/working-with-references/faxes-datasources.png)
...
> [!div class="mx-imgBorder"]
> ![Updated Text-Eigenschaft für das Untertitel-Steuerelement für Informationen zu Such Vorgängen ](media/working-with-references/regarding-label.png)
...
> [!div class="mx-imgBorder"]
> ![Animation, das zeigt, wie die Auswahl eines Elements im Katalog die anderen Steuerelemente und das Formular ändert ](media/working-with-references/regarding-allthree.gif)
...
> [!div class="mx-imgBorder"]
> ![Relationships der Faxe-Entität, die für n:1-Beziehungen angezeigt wird ](media/working-with-references/activity-manytoone.png)
...
> [!div class="mx-imgBorder"]
> ![Relationships der Konto Entität, die für 1: n-Beziehungen angezeigt wird ](media/working-with-references/activity-onetomany.png)
...
1. Einen weiteren Bildschirm hinzufügen.
    ...
    > [!div class="mx-imgBorder"]
    > ![Insert einen leeren Bildschirm an ](media/working-with-references/activitypointer-newscreen.png)
...
1. Legen Sie auf der Registerkarte **Eigenschaften** in der Nähe der rechten Seite des Bildschirms die **Elemente** des Katalogs auf **Accounts**fest.
    ...
    > [!div class="mx-imgBorder"]
    > ![Set Elemente zu Konten im Eigenschaften Bereich ](media/working-with-references/activitypointer-accounts.png)

1. Legen Sie das Layout des Katalogs auf **Title**fest, und legen Sie dann das Feld Title auf **Account Name**fest.

    > [!div class="mx-imgBorder"]
    > ![Set Layout zum Titel für das Katalog Steuerelement im Bereich "Eigenschaften" ](media/working-with-references/activitypointer-account-name.png)
...
1. Legen Sie die **Items** -Eigenschaft des neuen Katalogs auf `Gallery2.Selected.Faxes` fest.
    ...
    > [!div class="mx-imgBorder"]
    > ![Set Sie die Items-Eigenschaft des Katalogs, in dem Faxe angezeigt werden ](media/working-with-references/activitypointer-faxes.png)
...
1. Legen Sie das Layout des Katalogs auf **Titel und Untertitel**fest, und legen Sie dann das Feld Titel so fest, dass das Feld **Betreff** (in klein **Buchstaben) angezeigt**wird.
    ...
    > [!div class="mx-imgBorder"]
    > ![Set Titel für Betreff-Feld ](media/working-with-references/activitypointer-subject.png)
...
> [!div class="mx-imgBorder"]
> ![List von Entitäten, die die Aktivitäts Entität zeigen ](media/working-with-references/activitypointer-entity.png)
...
> [!div class="mx-imgBorder"]
> ![Change der Items-Eigenschaft für den zweiten Katalog, Ändern von Faxe in Aktivitäten ](media/working-with-references/activitypointer-gallery.png)
...
> [!div class="mx-imgBorder"]
> ![Data Bereich, der alle Entitäten anzeigt, die für die istype-Funktion erforderlich sind ](media/working-with-references/activity-datasources.png)
...
> [!div class="mx-imgBorder"]
> ![Set Text-Eigenschaft in Formel, um Informationen für Faxe, Telefonanrufe und andere Aktivitäten anzuzeigen ](media/working-with-references/activitypointer-type.png)
...
> [!div class="mx-imgBorder"]
> ![Expanded Text-Eigenschaft mit weiteren Informationen für einen Telefonanruf ](media/working-with-references/activitypointer-phonecall.png)
...
> [!div class="mx-imgBorder"]
> ![Completed Bildschirm, der Informationen für verschiedene Arten von Aktivitäten anzeigt ](media/working-with-references/activitypointer-complete.png)
...
> [!div class="mx-imgBorder"]
> ![Enabling Anlagen und Notizen beim Erstellen einer Entität ](media/working-with-references/notes-entity.png)
...
> [!div class="mx-imgBorder"]
> ![Account Entität, die eine Beziehung zu Notizen über eine 1: n-Beziehung anzeigt ](media/working-with-references/notes-relationships.png)
