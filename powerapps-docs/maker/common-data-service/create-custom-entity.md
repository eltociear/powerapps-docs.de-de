...
2. Geben Sie im rechten Fensterbereich die folgenden Werte ein und wählen Sie dann **Erstellen**.
...
5. Klicken Sie auf der Registerkarte **Felder** auf der Entitätsdesignersymbolleiste und wählen Sie die Option aus **Feld hinzufügen** Klicken Sie auf den Bereich **Feldeigenschaften** und geben Sie ein oder wählen Sie die folgenden Werte und Optionen.
    - **Anzeigename**. *Spezies*
    - **Datentyp**. *Optionssatz*
    - **Optionssatz**. *Neuer Optionssatz*
  
6. Wählen Sie **Mehrere anzeigen**, und wählen Sie dann **Optionen lokal einstellen**.

7. Einen Optionssatz erstellen

      a. Ersetzen Sie **Neue Option** mit *Hund*. 
      
      b. Wählen Sie **Neue Einheit hinzufügen**. 
        
      c.  Ersetzen Sie **Neue Option** mit *Katze*. 
...
8. Wählen Sie **Durchsuchbar** und dann **Fertig** aus.
...
1. Wählen Sie die Registerkarte **Ansichten**, und wählen Sie dann **Aktive Haustiere** aus der Ansicht aus. Wenn Sie die Ansicht **Aktive Haustiere** nicht sehen, ändern Sie den Filter in der Befehlsleiste von **Standard** auf **Alle**.
...
3. Wählen Sie die Spalte **Erstellt am** und wählen Sie dann **Entfernen**.

4. Um die Spalten anzuordnen, wählen Sie die Spalte, die Sie verschieben möchten, und verwenden Sie dann **Nach links bewegen** und **Nach links bewegen**, bis Ihre Ansicht wie folgt aussieht.
    > [!div class="mx-imgBorder"] 
    > ![Aktive Haustieransicht](media/create-custom-entity/active-pets-view.png)

5. Wählen Sie in der Symbolleiste des Ansichts-Designers **Speichern**.  
...
2. Wählen Sie das Register **Formulare** und wählen Sie dann **Informationen** neben **Haupt** Formulartyp, um den Formulardesigner zu öffnen.
...
6. Rückkehr zur Power Apps Startseite.
