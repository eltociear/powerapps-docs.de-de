---
title: 'Schnellstart: Common Data Service für Apps | Microsoft-Dokumentation'
description: Schnellstart für das Erstellen einer neuen Geschäftsregel
...
---
# <a name="quickstart-create-a-new-business-rule"></a>Schnellstart: Erstellen einer neuen Geschäftsregel
...
1. Klicken oder tippen Sie in der angezeigten Liste auf **Entitäten**.
  
1. Öffnen Sie die Entität, für die Sie die Geschäftsregel erstellen möchten (z.B. die Entität **Account**), und klicken Sie dann auf die Registerkarte **Geschäftsregeln**.  
...
1.  Fügen Sie im Feld „Beschreibung“ in der oberen linken Ecke des Fensters nach Belieben eine Beschreibung hinzu.  
  
1.  Legen Sie den Bereich folgendermaßen fest:  
...
1. **Hinzufügen von Bedingungen:** So fügen Sie Ihrer Geschäftsregel weitere Bedingungen hinzu:  
...
9. **Hinzufügen von Aktionen:** So fügen Sie eine Aktion hinzu:  
...
10. **Hinzufügen einer Geschäftsempfehlung (nur für modellgesteuerte Apps):** So fügen Sie eine Geschäftsempfehlung hinzu:  
...
11. Klicken Sie in der Aktionsleiste auf **Überprüfen**, um eine Geschäftsregel zu überprüfen.  
  
12. Klicken Sie in der Aktionsleiste auf **Speichern**, um eine Geschäftsregel zu speichern.  
  
13. Wenn Sie eine Geschäftsregel aktivieren möchten, wählen Sie diese im Fenster des Projektmappen-Explorers aus, und klicken Sie dann auf **Aktivieren**. Sie können keine Geschäftsregel über das Fenster des Designers aktivieren.  
